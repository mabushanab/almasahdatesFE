...
class SaleOrderPerCustomer extends StatefulWidget {
  final Customer selectedCustomer;
  const SaleOrderPerCustomer({super.key, required this.selectedCustomer});

  @override
  State<SaleOrderPerCustomer> createState() => _SaleOrderPerCustomer();
}

class _SaleOrderPerCustomer extends State<SaleOrderPerCustomer> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: () => _showAddSaleOrderDialog(context, items),
            icon: const Icon(Icons.add),
          ),
        ],
      ),
